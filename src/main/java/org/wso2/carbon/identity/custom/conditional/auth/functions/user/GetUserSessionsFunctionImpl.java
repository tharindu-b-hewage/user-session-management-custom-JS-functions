...
public class GetUserSessionsFunctionImpl implements GetUserSessionsFunction {
    ...
    public List<String> getUserSessions(JsAuthenticatedUser user) {
        ...
        List<String> sessionsIdsForUser = null;
        ...
        try {
            ...
            if (userRealm != null) {
                ...
                if (userStore != null) {
                    String userId = UserSessionStore.getInstance().getUserId(username,
                            Utils.getTenantId(tenantDomain), userStoreDomain);
                    sessionsIdsForUser =
                            UserFunctionsServiceHolder.getInstance().getUserSessionManagementService().getSessionsByUserId(userId);
                }
            }
